...
The **sample space** $\Omega$ is the set of all possible outcomes of a random phenomenon/process/"experiment", e.g., tossing a coin.
...
### Disjunction (sum/addition rule; OR logical operator)
...
### Conjunction (product/multiplication rule; AND logical operator)
