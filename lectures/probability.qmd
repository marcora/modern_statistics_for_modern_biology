...
-   Logic is the study of (the rules of) correct reasoning, i.e., valid/strong arguments/inferences.
-   An argument/inference is a set of propositions/claims; more specifically a set of premises together with a conclusion.
-   Probability is an essential component of *inductive reasoning* (i.e., arguments/inferences about unknowns from knowns).
-   Probability theory is the study of (the rules of) probability as a mathematical object.
-   Inductive reasoning is an essential component of *scientific reasoning* in general and *statistical inference* in particular.
...
-   People suck at reasoning with probabilities.
