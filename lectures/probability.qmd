...
Because people suck at reasoning with probabilities (i.e., *inductive reasoning*), the foundation of *scientific reasoning* in general and *statistical inference* in particular.

## Inductive vs. deductive reasoning

-   Logic is the study of reasoning (i.e., arguments/inferences).
